---
name: ios-hig-design
description: 'Design native iOS interfaces following Apple Human Interface Guidelines. Covers navigation patterns, accessibility, SF Symbols, and platform conventions.'
---
...
**Clarity:** Every element must be legible and purposeful.
**Deference:** The interface should never overshadow the content it presents.
**Depth:** Layering, transitions, and motion convey hierarchy and spatial relationships.
